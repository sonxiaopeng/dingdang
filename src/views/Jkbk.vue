    ...
    <div class="box">
      ...
      <van-row type="flex" align="center" justify="space-around" class="query">
        ...
        <van-col span="6">
          <van-image
            width="40"
            :src="require('../assets/Check-the-vaccine4.png')"
          />
          <p>查疫苗</p>
        </van-col>
        <van-col span="6">
          <van-image
            width="40"
            :src="require('../assets/operative-treatment5.png')"
          />
          <p>手术检查</p>
        </van-col>
        <van-col span="6">
        ...
        <van-col span="6">
          <van-image width="40" :src="require('../assets/Summer-guide7.png')" />
          <p>夏季指南</p>
        </van-col>
        <van-col span="6">
          <van-image
            width="40"
            :src="require('../assets/popular-video8.png')"
          />
          <p>科普视频</p>
        </van-col>
      </van-row>
  ...
  mounted() {
    ...
    this.axios.get('/jkbk').then(result=>{
      ...
      titleImg.forEach(element => {
        element.background_img=require("../assets/img/"+element.background_img)
      });
